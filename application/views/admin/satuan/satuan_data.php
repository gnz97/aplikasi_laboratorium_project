                                ...
                                <div class="col-md-12 col-sm-12">
                                    <div class="x_panel">
                                        <div class="x_title d-flex bd-highlight" >
                                            ...
                                            <div class="bd-highligh"> <a href="<?=site_url('admin/Satuan/viewAddSatuan')?>"><button type="submit" class="btn btn-success ">Tambah Data</button></a> </div>
                                            ...
                                            <div class="card-box table-responsive">
                                                <table class="table table-striped jambo_table bulk_action" id="datatableSatuan" style="width: 100%;" role="grid">
                                                    ...
                                                    <tbody>
                                                        <?php 
                                                            $i = 1;
                                                            foreach($satuanData as $rowSatuan){?>
                                                            <tr role="row" class="odd">
                                                                <td class="a-center "><?=$i++?></td>
                                                                <td class=" "><?=$rowSatuan->satuanNama?></td>
                                                                <td class=" ">
                                                                    <a href="<?= base_url('admin/Satuan/viewEditSatuan/'.$rowSatuan->satuanID)?>"><button class="btn btn-primary btn-sm" id="btn-edit">Edit</button></a>  
                                                                    <button class="btn btn-danger btn-sm" id="btn-delete" value="<?=$rowSatuan->satuanID?>">Delete</button>
                                                                </td>
                                                            </tr>
                                                        <?php } ?>
...
$(document).ready(function() {
    ...
    $('#datatableSatuan').on('click','#btn-delete',function(){
        ...
        if (result.isConfirmed) {
            $.ajax({
            type : "POST",
            url  : "<?php echo base_url('admin/Satuan/deletSatuan')?>",
            dataType : "JSON",
            data : {id: id},
