								...
								<div class="x_content ">
									...
									<form  id="formAdd" data-parsley-validate="" class="form-horizontal form-label-left d-flex justify-content-center" novalidate="" >			
										<div class="col-md-8 ">
											<div class="x_panel ">
												<div class="x_title">
													<h2 class="align-center">Edit dokter</h2>
													<div class="clearfix"></div>
												</div>
												<div class="x_content">
													<div class="form-group row ">
														<label class="control-label col-md-3 col-sm-3 ">dokter Nama</label>
														<div class="col-md-9 col-sm-9 ">
															<input type="hidden" id="dokterID"  name="dokterID" class="form-control" value="<?=$rowdokter->dokterID?>">
                                                            <input type="text" id="dokterNama"  name="dokterNama" class="form-control" value="<?=$rowdokter->dokterNama?>">
                                                    ...
                                                    <div class="form-group row ">
														...
														<div class="col-md-9 col-sm-9 ">
                                                            <input type="text"  id="dokterJk" name="dokterJk" class="form-control" value="<?=$rowdokter->dokterJk?>">
                                                    ...
                                                    <div class="form-group row ">
														...
														<div class="col-md-9 col-sm-9 ">
                                                            <input type="file" id="dokterTandaTangan" name="dokterTandaTangan" class="form-control" >
                                                            <input type="hidden" id="dokterTandaTangan_old" name="dokterTandaTangan_old" class="form-control" value="<?=$rowdokter->dokterTandaTangan?>">
...
$(document).ready(function(){
    ...
    //     $.ajax({
    //         type : "POST",
    //         url  :"<?php echo base_url('admin/Dokter/editDokter')?>",
    //         dataType : "JSON",
    ...
    $('#edit').on('click', function(e){
        ...
        myformData.append('dokterID', $("#dokterID").val());
        myformData.append('dokterNama', $("#dokterNama").val());
        myformData.append('dokterJk', $("#dokterJk").val());
        myformData.append('dokterTandaTangan_old', $("#dokterTandaTangan_old").val());
