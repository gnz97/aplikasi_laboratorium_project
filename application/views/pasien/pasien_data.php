                                ...
                                <div class="col-md-12 col-sm-12">
                                    <div class="x_panel">
                                        <div class="x_title d-flex bd-highlight" >
                                            ...
                                            <div class="bd-highligh"> <a href="<?=site_url('Pasien/pasienBaru/')?>"><button type="submit" class="btn btn-success ">Tambah Data</button></a> </div>
                                                    ...
                                                    <tbody>
                                                        <?php 
                                                            ...
                                                            <tr role="row" class="odd">
                                                                ...
                                                                <td class=" "><?=$rowPasien->pasienNoRM?></td>
                                                                <td class=" "><?=$rowPasien->pasienNamaLengkap?></td>
                                                                <td class=" "><?=$rowPasien->pasienJK?></td>
                                                                <td class=" ">
                                                                    <a href="<?= base_url('Pasien/pasienUpdate/'.$rowPasien->pasienID)?>"><button class="btn btn-primary btn-sm" id="btn-edit">Edit</button></a>  
                                                                    <a href="<?= base_url('Pasien/pasienViewDetail/'.$rowPasien->pasienID)?>"><button class="btn btn-primary btn-sm" id="btn-edit">Detail</button></a>  
                                                                    <!-- <button class="btn btn-danger btn-sm" id="btn-delete" value="<?=$rowPasien->pasienID?>">Delete</button> -->
                                                                </td>
                                                            </tr>
                                                        <?php } ?>
