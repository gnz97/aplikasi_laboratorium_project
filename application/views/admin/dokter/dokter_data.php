                                ...
                                <div class="col-md-12 col-sm-12">
                                    <div class="x_panel">
                                        <div class="x_title d-flex bd-highlight" >
                                            ...
                                            <div class="bd-highligh"> <a href="<?=site_url('admin/Dokter/viewAdddokter')?>"><button type="submit" class="btn btn-success ">Tambah Data</button></a> </div>
                                                ...
                                                <table class="table table-striped jambo_table bulk_action" id="datatableParam" style="width: 100%;" role="grid">
                                                    ...
                                                    <?php 
                                                            ...
                                                            <tr role="row" class="odd">
                                                                ...
                                                                <td class=" "><?=$rowdokter->dokterNama?></td>
                                                                <td class=" "><?=$rowdokter->dokterJk?></td>
                                                            
                                                              
                                                                <td class=" ">
                                                                    <a href="<?= base_url('admin/dokter/viewEditdokter/'.$rowdokter->dokterID)?>"><button class="btn btn-primary btn-sm" id="btn-edit">Edit</button></a>  
                                                                    <button class="btn btn-danger btn-sm" id="btn-delete" value="<?=$rowdokter->dokterID?>">Delete</button>
                                                                </td>
                                                            </tr>
                                                        <?php } ?>
                                                    </tbody>
...
$(document).ready(function() {
    ...
    $('#datatableParam').on('click','#btn-delete',function(){
        ...
        if (result.isConfirmed) {
            $.ajax({
            type : "POST",
            url  : "<?php echo base_url('admin/Dokter/deletdokter')?>",
            dataType : "JSON",
            data : {id: id},
